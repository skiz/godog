...
test: check-go-version
	...
	@go fmt ./...
	@go run honnef.co/go/tools/cmd/staticcheck@v0.5.0 github.com/cucumber/godog
	@go run honnef.co/go/tools/cmd/staticcheck@v0.5.0 github.com/cucumber/godog/cmd/godog
	go vet ./...
	go test -race ./...
